...
var index = 0;
var map = new Map();
function addToMap(number, index) {
    if (index > 1) {
        var val = map.get(index - 2) || 0;
        map.set(index - 2, val + number);
    }
    if (index > 0) {
        var val = map.get(index - 1) || 0;
...
function process() {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var stream, rl, rl_1, rl_1_1, line, nbr, e_1_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    stream = (0, fs_1.createReadStream)('input.txt');
